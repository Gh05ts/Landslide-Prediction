...
void loop() {
  ...
  {  
    ...
    Send(mpu6050.getAccX(), mpu6050.getAccY(), mpu6050.getAccZ()+0.05, mpu6050.getAngleX()+1.7, mpu6050.getAngleY()-0.8, mpu6050.getAngleZ()+0.6, val);       // Uploading data to Thingspeak
...
void Send(float data1, float data2, float data3, float data4, float data5, float data6, int data7) {
  String str = "GET http://api.thingspeak.com/update?api_key=VSM4ILHBYBUOZSS6&field1="+String(data1)+"&field2="+String(data2)+"&field3="+String(data3)+"&field4="+String(data4)+"&field5="+String(data5)+"&field6="+String(data6)+"&field7="+String(data7);
